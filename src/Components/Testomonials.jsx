...
const Testimonials = () => {
  return (
    <section className="font-display py-16 px-8">
      ...
      <div className="max-w-3xl mx-auto">
        <blockquote className="mb-6">
          ...
          <cite className="text-gray-500 mt-2 block text-right">— Borostyán Szikvíz</cite>
        </blockquote>
        <blockquote>
          <p className="text-gray-700 italic">
          ...
          <cite className="text-gray-500 mt-2 block text-right">— Szén Róbert</cite>
        </blockquote>
      </div>
    </section>
  );
