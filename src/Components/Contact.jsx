      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='md:text-center'>
          <h2 className='font-display text-3xl tracking-tight text-white sm:text-4xl'>
            <span className='relative whitespace-nowrap'>
              ...
              <span className='relative'>Kapcsolat,</span>
            </span>{' '}
            for everyone.
          </h2>
        ...
        <div className='max-w-xl mx-auto'>
          <form onSubmit={handleSubmit}>
            ...
            <button
              type='submit'
              className='ring-1 inline-flex py-2 px-4 text-white text-sm rounded-full ring-slate-700 focus:outline-hidden hover:ring-slate-500 active:ring-slate-700 focus-visible:outline-white mt-8'
            >
              Üzenet küldése
            </button>
